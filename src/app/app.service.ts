...
export class AppService {
    ...
    API_GET_ALL_BS_DATA = "getBsDataUserId";
    API_SAVE_BS_DATA = "storeBsData";
    API_UPDATE_BS_DATA = "updateBsData";
    API_DELETE_BS_DATA = "deleteBsData";
  ...
  calculateBsHighLow(fbs: number, pp: number, goodnessVal: number) {
        ...
        let constVal = AppConstant.BLOOD_SUGAR_VALUE;
  ...
  //#endregion Cookie
    ...
    getBsRecords(apiFuncParams: any) {
        return this.callRestApi(this.API_GET_ALL_BS_DATA, apiFuncParams);
    }

    saveBsRecord(apiFuncParams: any) {
        return this.callRestApi(this.API_SAVE_BS_DATA, apiFuncParams);
    }

    updateBsRecord(apiFuncParams: any) {
        return this.callRestApi(this.API_UPDATE_BS_DATA, apiFuncParams);
    }

    deleteBsRecord(apiFuncParams: any) {
        return this.callRestApi(this.API_DELETE_BS_DATA, apiFuncParams);
    }
